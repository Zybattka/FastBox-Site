...
<body>
    ...
    <section class="package-content">
        <div class="container">
            <div class="package-content__package-text-container">
                <h1 class="package-text-container__title">основной склад:</h1>
                <a href="packageTwo.php" class="package-text-container__link">посмотреть новый склад</a>
            </div>

            <?php
                $connect = mysqli_connect('localhost', 'root', 'admin', 'FastBox_bd');

                $products_card = "SELECT * FROM `products`";
                        ...
                        <div class="products-card">
                            ...
                            <div class="products-card__container-info-products">
                                ...
                                <div class="descr-products__data-container">
                                    ...
                                    <!-- Если мы будем входить под профилем со статусом admin, то будет отображаться кнопки "изменение товара" и "удалить товар" -->
                                    <?php

                                    if (!empty($_SESSION['user']['status'] == 'admin')) {

                                    ?>
                                        <!-- Таким образом с помощью $products_info['id'] в href мы будем переходить и изменять товар -->
                                        <!-- с тем ключом, который привязан к данному товару -->

                                        <a class="data-container__btn-update-product" href="updateProducts.php?id=<?= $products_info['id']?>">

                                            Изменить товар
                                        </a>
                                        <a class="data-container__btn-delete-product" href="include/deleteProducts.php?id=<?= $products_info['id'] ?>">
                                    ...
                                    ?>
                                    <a href="detailedInformation.php?id=<?= $products_info['id'] ?>" class="data-container__btn-detailed-information">
