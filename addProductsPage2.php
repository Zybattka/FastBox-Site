...
<section class="add-products-content">
    <div class="container">
        ...
        <form class="add-products-form" action="include/addProducts2.php" method="post" enctype="multipart/form-data">
            ...
            <label class="add-products-form__label">Колличество товаров:</label>
            ...
            <button class="add-products-form__btn" type="submit">Добавить товар на новый склад</button>
        </form>
    </div>
