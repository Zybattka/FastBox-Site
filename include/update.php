...
mysqli_query($connect, "UPDATE `products` SET `name_products` = '$name_products', `descr_products` = '$descr_products', `data_products` = '$data_products', `numbers_products` = '$numbers_products', `batch_number` = '$batch_number', `from_what_city` = '$from_what_city', `provider` = '$provider', `compound` = '$compound', `best_before_date` = '$best_before_date' WHERE `products`. `id` = '$id'");
