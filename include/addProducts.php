...
if ($_POST) {
    ...
    mysqli_query($connect, "INSERT INTO `products` (`id`, `name_products`, `img_products`, `descr_products`, `data_products`, `numbers_products`, `batch_number`, `from_what_city`, `provider`, `compound`, `best_before_date`) VALUES (NULL, '$name_products', '$path',
    ...
    // С помощью этой команды, мы добавляем запись в таблицу MySQL.
    // $addProducts = "INSERT INTO products (name_products, img_products, descr_products, data_products, numbers_products) VALUES";
